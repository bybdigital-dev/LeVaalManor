...
const testimonials = [
  ...
  },
  {
    ...
    location: "",
    rating: 5,
    text: "What an amazing experience! From the moment we walked in, we could see how much care and thought went into every detail. The space is stunning, beautifully decorated, and so well equipped. Everything felt fresh, clean, and perfectly arranged. It's rare to find a place that feels both luxurious and homely at the same time and just perfect in every way. We felt so comfortable and relaxed. Highly recommended — we will definitely be back!",
  },
  {
    id: 3,
    name: "Eric Jensen",
