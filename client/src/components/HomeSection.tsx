        ...
        <div className="relative z-10 container mx-auto px-4 md:px-6 text-center">
          <div className="max-w-4xl mx-auto space-y-6 md:space-y-8">
            <div className="space-y-3">
              <p className="text-accent font-body text-sm md:text-base font-medium tracking-[0.3em] uppercase">
                Parys Golf Estate, South Africa
              </p>
              <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold text-white font-serif tracking-tight">
                Le Vaal Manor
              </h1>
            </div>
            <p className="text-lg md:text-xl lg:text-2xl text-white/90 font-body max-w-2xl mx-auto font-light leading-relaxed">
            ...
            <div className="pt-4 md:pt-6">
              <Button
                size="lg"
                className="bg-accent text-accent-foreground border-accent-border font-body font-semibold text-base md:text-lg shadow-lg"
